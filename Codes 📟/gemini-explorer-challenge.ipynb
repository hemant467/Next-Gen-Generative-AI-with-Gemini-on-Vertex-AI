 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "PROJECT_ID = \"qwiklabs-gcp-00-b31058482eae\"  # @param {type:\"string\"}\n",
   ...
   "outputs": [
    ...
    },
    {
     ...
     "text": [
      ...
      "Based on the video:\n",
      "\n",
      "1.  **What is shown in this video?**\n",
      "    The video shows an aerial view of a picturesque coastal city. It features a prominent marina or harbor filled with boats, including what appears to be a large pirate-ship styled tourist boat. A long, rocky breakwater with a lighthouse at its end extends into the vibrant blue-green sea, with waves crashing against it. The city itself is built along dramatic, rocky cliffs that overlook the harbor and the open sea, with numerous buildings (likely apartments or hotels) visible along the clifftops.\n",
      "\n",
      "2.  **Where should I go to see it?**\n",
      "    This specific location is the **Kaleiçi Marina (Old City Marina) in Antalya, Turkey**.\n",
      "\n",
      "3.  **What are the top 5 places in the world that look like this?**\n",
      "    Looking for coastal cities/towns with dramatic cliffs, clear water, and often a marina or harbor, here are 5 similar places:\n",
      "\n",
      "    1.  **Santorini, Greece:** Famous for its white-washed villages perched on volcanic cliffs overlooking the Aegean Sea and its caldera.\n",
      "    2.  **Amalfi Coast, Italy (e.g., Positano, Amalfi):** Iconic towns built into steep, colorful cliffs that plunge into the deep blue Mediterranean Sea, often featuring small harbors.\n",
      "    3.  **Dubrovnik, Croatia:** The \"Pearl of the Adriatic,\" an ancient walled city spectacularly situated on rocky cliffs overlooking the Adriatic Sea.\n",
      "    4.  **Cinque Terre, Italy:** A string of five colorful fishing villages precariously perched on rugged cliffs and mountainsides along the Italian Riviera, with terraced vineyards and small harbors.\n",
      "    5.  **Lagos, Portugal (Algarve region):** Known for its dramatic golden cliffs, natural grottoes, and beautiful beaches, with the town and marina situated near these stunning coastal features."
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "id": "b9b409d9-5cd0-4b78-89c5-59ecf7abe4fb",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "6c54d72d-68a4-476d-950f-7c1c4d29e67c",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "1837acb5-e3e2-48ae-afed-540f1f1c2e9f",
   "metadata": {},
   "outputs": [],
   "source": []
  }
